...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.CLOCK_TYPE {Differential} $sim_clk_gen_0


  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins simpleCpu_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net sim_clk_gen_0_diff_clk [get_bd_intf_pins sim_clk_gen_0/diff_clk] [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
