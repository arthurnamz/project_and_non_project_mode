...
user.org:user:mysimple_multi:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M05_AXI [get_bd_intf_pins axi_smc/M05_AXI] [get_bd_intf_pins mysimple_multi_0/S00_AXI]
  ...
  [get_bd_pins mysimple_multi_0/s00_axi_aclk]
  connect_bd_net -net reset_rtl_0_1  [get_bd_ports reset] \
  ...
  [get_bd_pins mysimple_multi_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs mysimple_multi_0/S00_AXI/S00_AXI_reg] -force
