...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arthur/Documents/FPGA_master_class/project_and_non_project_mode/microblaze_new_part/hw/project_1/project_1.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
