#line 1 "../platform_new/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../platform_new/hw/sdt/pl.dtsi"
/ {
	...
	amba_pl: amba_pl {
		...
		mysimple_multi_0: mysimple_multi@44a10000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,mysimple-multi-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <4>;
			xlnx,ip-name = "mysimple_multi";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44a10000 0x10000>;
			xlnx,name = "mysimple_multi_0";
		};
		simpleCpu_0: simpleCpu@44a00000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,simpleCpu-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <4>;
			xlnx,ip-name = "simpleCpu";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44a00000 0x10000>;
			xlnx,name = "simpleCpu_0";
		};
	};
};
#line 3 "../platform_new/hw/sdt/system-top.dts"
/ {
	device_id = "7s50";
	#address-cells = <1>;
	#size-cells = <1>;
	...
	cpus_microblaze_0: cpus_microblaze@0 {
		address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x10000>,
			      ...
			      <0x44a00000 &simpleCpu_0 0x44a00000 0x10000>,
			      <0x44a10000 &mysimple_multi_0 0x44a10000 0x10000>;
