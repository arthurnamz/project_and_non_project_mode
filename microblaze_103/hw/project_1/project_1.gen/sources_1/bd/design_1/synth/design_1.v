...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=17,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=3,da_mb_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (clk_out,
    gpio_tri_o,
    reset,
    ...
    uart_txd);
  output clk_out;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 gpio TRI_O" *) (* X_INTERFACE_MODE = "Master" *) output [31:0]gpio_tri_o;
  ...
  design_1_clk_wiz_1_0 clk_wiz_1
       (.clk_in1_n(sim_clk_gen_0_diff_clk_CLK_N),
        .clk_in1_p(sim_clk_gen_0_diff_clk_CLK_P),
        .clk_out1(clk_out),
