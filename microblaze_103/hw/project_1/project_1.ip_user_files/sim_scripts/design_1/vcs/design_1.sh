...
compile()
{
  ...
  vlogan -work util_vector_logic_v2_0_4 $vlogan_opts +v2k +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/3cbc" +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/0127/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vhdlan -work axi_timer_v2_0_35 $vhdlan_opts \
  ...
  vhdlan -work axi_intc_v4_1_20 $vhdlan_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/arthur/Documents/FPGA_master_class/project_and_non_project_mode/microblaze_103/hw/project_1/project_1.cache/compile_simlib/vcs"
  fi
